...
//		assertEquals(ele1.getMotorState(), MotorState.IDLE);
...
//		assertEquals(ele1.getMotorState(), MotorState.MOVING_UP);
//	}
//	
//	/**
//	 * Test whether the current state of the Elevator will be correctly changed 
