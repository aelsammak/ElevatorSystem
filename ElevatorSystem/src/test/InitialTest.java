...
//        assertEquals(2, floor2.peek().getCurrentFloorNumber().getFloorNumber()); 
//        assertEquals(4, floor4.peek().getCurrentFloorNumber().getFloorNumber()); 
//        assertEquals(3, floor3.peek().getCurrentFloorNumber().getFloorNumber());  
//        
